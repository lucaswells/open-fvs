      ...
      IMPLICIT NONE
C----------
C CANADA-BC $Id: becset.f 3859 2021-12-16 01:17:07Z donrobinson $
C----------
C
...
cKOTTYP = 250, MTYPE=, JTYP=15, Itype=  4
cKOTTYP = 310, MTYPE=, JTYP=18, itype=  7
cKOTTYP = 320, MTYPE=, JTYP=19, Itype=  8
cKOTTYP = 420, MTYPE=, JTYP=28, Itype= 10
cKOTTYP = 470, MTYPE=, JTYP=33, Itype= 11
cKOTTYP = 620, MTYPE=, JTYP=58, Itype= 19
cKOTTYP = 640, MTYPE=, JTYP=61, Itype= 20
cKOTTYP = 660, MTYPE=, JTYP=63, Itype= 21
cKOTTYP = 670, MTYPE=, JTYP=64, Itype= 22
cKOTTYP = 730, MTYPE=, JTYP=73, Itype= 27
     
c     DATA KTYPE/
c    &  5*1, 4*2, 4, 3*1, 3,4,5,6,7,8,9,8,8,9,7,3, 3*10, 4,11,20,29,11,      !33
c    &    11,13,14,17, 4*12, 3*13, 14,15,14,16,14,16, 3*17, 24,12,24,18,     !57
c    &    19,21,19,20,20,21,22,19,23,19,24,27,25,25,26,27,22,24,27,24,
c    &    27,28,28,29,28,28, 4*29, 27,9,20,24,21,27,24,30/
c     DATA MTYPE/
c    &            130,170,250,260,280,290,310,320,330,420,
c    &            470,510,520,530,540,550,570,610,620,640,
c    &            660,670,680,690,710,720,730,830,850,999/    
c     DATA JTYPE / 10,100,110,130,140,160,170,180,190,200,
c    &            210,220,230,250,260,280,290,310,320,330,
c    &            340,350,360,370,380,400,410,420,430,440,
c    &            450,460,470,480,500,501,502,505,506,510,
c    &            515,516,520,529,530,540,545,550,555,560,
c    &            565,570,575,579,590,600,610,620,630,635,
c    &            640,650,660,670,675,680,685,690,700,701,
c    &            710,720,730,740,750,770,780,790,800,810,
c    &            820,830,840,850,860,870,890,900,910,920,
c    &            925,930,940,950,999,27*0 / 
c
c          DO 100 K=1,95
c          IF (KODTYP .LT. JTYPE(K)) GO TO 110
c 100      CONTINUE
c          K=96
c 110      CONTINUE
c          ITYPE=KTYPE(K-1)
