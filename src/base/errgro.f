      ...
      IMPLICIT NONE
C----------
C BASE $Id: errgro.f 3856 2021-12-08 03:07:46Z lancedavid $
C----------
C
...
C                        ERROR NUMBER 39
 ...
 4910 FORMAT(/A11,'FVS39 WARNING:  USER DEFINED VARIABLE NAME',
     &     ' CONTAINS INVALID SPECIAL CHARACTERS. EQUATION IGNORED.')
      IF (ICCODE .LT. 1) ICCODE=1
      GO TO 9000
